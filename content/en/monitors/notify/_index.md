...
If changes are restricted, only the monitor's creator or a user with the Org Management (`org_management`) permission can change the monitor. Changes include any updates to the monitor definition and muting for any amount of time.
